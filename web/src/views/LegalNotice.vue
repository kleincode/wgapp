<template>
  <v-container style="min-height: 83vh">
    <v-row justify="center">
      <v-col cols="12">
        <div class="display-2 text-center mt-12 mb-6">Impressum</div>
      </v-col>
      <v-col cols="12" md="10" lg="8">
        ...
        <!-- DSGVO -->
        <div class="display-2 text-center mt-12 mb-6">Datenschutzerklärung</div>
        <p>
          Verantwortlicher im Sinne der Datenschutzgesetze, insbesondere der
          EU-Datenschutzgrundverordnung (DSGVO), ist: Felix Kleinsteuber
        </p>
